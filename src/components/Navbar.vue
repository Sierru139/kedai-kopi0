<template>
  <nav
    :class="[
      'fixed right-0 left-0 top-0 h-14 flex items-center justify-between md:px-20 px-5 md:mx-0 z-40 backdrop-blur-sm',
      isScrolled ? 'dot' : 'dotgone',
    ]"
  >
    ...
    <div class="md:hidden flex">
      ...
      >
        <a
          href="#home"
          class="hover:underline active:text-white"
